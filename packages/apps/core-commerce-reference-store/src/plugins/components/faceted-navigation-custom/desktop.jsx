 ...
 * @param props
 */
const customFacetedNavigationDesktop = props => {
...
customFacetedNavigationDesktop.propTypes = {
  /**
...
customFacetedNavigationDesktop.defaultProps = {
  totalNumRecs: 0,
 ...
 */
export default connect(getPageData)(customFacetedNavigationDesktop);
