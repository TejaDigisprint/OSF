...
export const customlogo = () => import('../index');

describe('customlogo renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {customlogo};
  beforeAll(async () => {
    /**
  ...
  it('customlogo works as expected', async done => {
    /**
