...
export const wishlistcustom = () => import('../index');

describe('wishlistcustom renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {wishlistcustom};
  beforeAll(async () => {
    /**
  ...
  it('wishlistcustom works as expected', async done => {
    /**
