...
import CustomLoginForm from './components/login-form/index';
  ...
  return (
    <Styled id="Login" css={css}>
      {!showMarketingPreferences && (
        <CustomLoginForm {...props} inProgress={inProgress} setInProgress={setInProgress}></CustomLoginForm>
      )}
      {showMarketingPreferences && (
...
export default connect(getLoggedInData)(CustomLogin);
