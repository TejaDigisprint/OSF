 ...
 * } props
 */
const CustomCategoryListingCarouselOne = props => {
  ...
  return (
    <Styled id="CategoryListingCarousel" css={css}>
      <div className="CategoryListingCarousel">
        <div className="CollectionCarousel__Heading">More Products You May Like </div>
...
CustomCategoryListingCarouselOne.defaultProps = {
  displayCollectionName: 'true',
  noOfItemsToSlide: '3'
};

export default CustomCategoryListingCarouselOne;
