...
export const saveforlaterview = () => import('../index');

describe('saveforlaterview renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {saveforlaterview};
  beforeAll(async () => {
    /**
  ...
  it('saveforlaterview works as expected', async done => {
    /**
