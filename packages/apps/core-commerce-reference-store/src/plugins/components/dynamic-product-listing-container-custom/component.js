 ...
 */
const customDynamicProductListingContainer = props => {
...
customDynamicProductListingContainer.propTypes = {
  /**
...
customDynamicProductListingContainer.defaultProps = {
  redirect: {},
  results: null,
  regions: [],
  contextId: null
...
export default connect(getComponentData)(customDynamicProductListingContainer);
