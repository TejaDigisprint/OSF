...
export const customfooter = () => import('../index');

describe('customfooter renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {customfooter};
  beforeAll(async () => {
    /**
  ...
  it('customfooter works as expected', async done => {
    /**
