 ...
 * @param props
 */
const CheckoutPaymentsContainerCustom = props => {
  const {
    id,
    isUserLoggedIn,
    regions = [],
...
CheckoutPaymentsContainerCustom.propTypes = {
  /**
...
CheckoutPaymentsContainerCustom.defaultProps = {
  isApprovalEnabled: undefined
};

export default connect(getCheckoutPaymentsContainerData)(CheckoutPaymentsContainerCustom);
