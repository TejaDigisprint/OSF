 ...
 */
  ...
  */
 const customReviewOrderSummary = props => {
   //resources
       ...
       <>
         {currentOrder &&
           ((currentOrder.id && numberOfItems > 0) || currentOrder.state === ORDER_STATE_PENDING_PAYMENT) && (
             <div className="CartReviewOrderSummary">
 ...
 customReviewOrderSummary.propTypes = {
 ...
 export default connect(getOrderData)(customReviewOrderSummary);
