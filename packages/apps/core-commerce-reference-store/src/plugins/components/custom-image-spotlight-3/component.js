 ...
 * @param props
 */
const CustomImageSpotlight3 = (props) => {
  // props
  const {
    ...
    return (
      <>
        <div className={`Image_ImgContainer ${imgCSS}`}>
          <Link href="/womens-brand/category/Wbrand1">
            <img
              className="Img_Tag"
             
              src="/file/general/adidaswomen.jpg"
              title={mediaTitle}
              alt={mediaAlt}
          ...
          <figcaption style={textStyle} className="Image_FigCaption">
            <h1 className="Image_h1">Women Brands</h1>
          </figcaption>
        </div>
        {mediaScreenText ? (
          <figcaption style={textStyle} className="Image_FigCaption">
...
CustomImageSpotlight3.propTypes = {
...
CustomImageSpotlight3.defaultProps = {
  mediaLink: "",
  mediaLinkBehavior: "",
  mediaScreenText: "",
  mediaScreenTextPosition: "",
...
export default CustomImageSpotlight3;
