 ...
 * } props
 */
const CustomCategoryListingCarouselTwo = props => {
  ...
  if (categoryProductIds) {
    ...
    let productIds = Object.values(categoryProductIds)
    for(let i=productIds.length-1; (i >=16)  && (i <= (productIds.length-1)); i--){
      slides.push(<ProductItem productId={productIds[i]} />);
    }
  }
  ...
  return (
    <Styled id="CategoryListingCarousel" css={css}>
      <div className="CategoryListingCarousel">
        <div className="CollectionCarousel__Heading">More Product to Visit</div>
...
CustomCategoryListingCarouselTwo.defaultProps = {
  displayCollectionName: 'true',
  noOfItemsToSlide: '1'
};

export default CustomCategoryListingCarouselTwo;
