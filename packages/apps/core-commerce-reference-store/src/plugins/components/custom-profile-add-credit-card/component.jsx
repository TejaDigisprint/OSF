 ...
 */
const CustomProfileAddCreditCard = props => {
          ...
          () =>
            isUserLoggedIn && (
              ...
              <section className="ResponsiveContainer__Section justifyCenter">
                <div className="ProfileAddCreditCard ProfileAddCreditCard_div Region col-8">
...
CustomProfileAddCreditCard.propTypes = {
  /**
 ...
 */
 CustomProfileAddCreditCard.defaultProps = {
  cardTypes: undefined
};

export default connect(getPageData)(CustomProfileAddCreditCard);
