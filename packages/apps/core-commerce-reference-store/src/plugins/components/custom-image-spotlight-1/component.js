 ...
 * @param props
 */
const CustomImageSpotlight1 = (props) => {
  // props
  const {
    mediaLink = "",
    mediaLinkBehavior = "",
    ...
    return (
      <>
        <div className={`Image_ImgContainer ${imgCSS}`}>
          <div>
          <Link href="/women-footwear/category/wf01">
            <img
              className="Img_Tag"
              src="/file/general/womenfware.jpg"
              title={mediaTitle}
              alt={mediaAlt}
          ...
          <figcaption style={textStyle} className="Image_FigCaption">
            <h1 className="Image_h1">Women Footwear</h1>
          </figcaption>
...
CustomImageSpotlight1.propTypes = {
...
CustomImageSpotlight1.defaultProps = {
  mediaLink: "",
  mediaLinkBehavior: "",
  mediaScreenText: "",
...
export default CustomImageSpotlight1;
