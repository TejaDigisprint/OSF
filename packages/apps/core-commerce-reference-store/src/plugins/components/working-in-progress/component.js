...
const WorkingInProgress = props => {
  return (
    <Styled id="WebContent" css={webContentCss}>
      <div className='outer_webContent' style={{backgroundColor:'#f0f2f4'}}>
      <div className="WebContent__Html" style={{textAlign:'center',fontSize:'13px',color:'#040c13',fontFamily:'Human BBY Digital,Human Fallback,Arial,Helvetica,sans-serif'}}>Working In Progress</div>
      </div>
     </Styled>
  );
};
