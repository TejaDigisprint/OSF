 ...
 * @param props
 */
const CheckoutSingleShippingDetailsCustom = props => {
  // resources
...
CheckoutSingleShippingDetailsCustom.propTypes = {
  /**
...
CheckoutSingleShippingDetailsCustom.defaultProps = {
  contactInfos: {},
  roles: [],
  defaultShippingCountry: ''
};

export default connect(getComponentData)(CheckoutSingleShippingDetailsCustom);
