    ...
    <Styled id="AddNewAddress" css={css}>
      <div className="AddNewAddress">
        <div
          role="button"
          tabIndex="0"
          className="AddNewAddress__Container addressContainerClass"
        ...
        >
          <span className="AddNewAddress__Icon addcustomaddressicon">
            <Plus />
          </span>
          <span className="AddNewAddress__Label addcustomaddresslabel">{labelAddANewAddress}</span>
        </div>
