 ...
 * @param props
 */
const CustomProductBreadcrumbs = props => {
    ...
    if (previousBreadcrumbs && previousBreadcrumbs.searchCrumbs && previousBreadcrumbs.searchCrumbs.length > 0) {
      return (
        <Styled id="ProductBreadcrumbs" css={css}>
          <div className="CustomProductBreadcrumbs">
...
CustomProductBreadcrumbs.propTypes = {
  /**
...
CustomProductBreadcrumbs.defaultProps = {
  breadcrumbs: {},
  pages: {},
  productId: '',
  products: {}
...
export default connect(getPageData)(CustomProductBreadcrumbs);
