...
const CustomProfileUpdatePassword = props => {
  ...
  return (
    <Styled id="ProfileUpdatePassword" css={css}>
      {isUserLoggedIn && firstName && (
        <div className="ProfileUpdatePassword ProfileUpdatePassword_div">
            ...
            >
              ...
              <div className="ProfileUpdatePassword__Buttons">
                <button
                  ...
                  className="ProfileUpdatePassword__SubmitButton saveBtn"
                >
                  {actionSave}
                </button>
                <button
...
CustomProfileUpdatePassword.propTypes = {
  /**
...
export default connect(getPageData)(CustomProfileUpdatePassword);
