...
export const locateastore = () => import('../index');

describe('locateastore renders correctly and shows after changing visible state', () => {
  /**
   * Reference to dynamic imported comps to resolve and preload.
   */
  const comps = {locateastore};
  beforeAll(async () => {
    /**
  ...
  it('locateastore works as expected', async done => {
    /**
