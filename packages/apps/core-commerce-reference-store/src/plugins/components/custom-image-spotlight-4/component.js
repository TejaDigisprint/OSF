 ...
 * @param props
 */
const CustomImageSpotlight4 = (props) => {
  // props
  const {
    ...
    return (
      <>
        <div className={`Image_ImgContainer ${imgCSS}`}>
          <Link href="/men-footwear/category/MF01">
            <img
              className="Img_Tag"
              src="/file/general/mensfootware.jpg"
              title={mediaTitle}
              alt={mediaAlt}
          ...
          <figcaption style={textStyle} className="Image_FigCaption">
            <h1 className="Image_h1">Men Footwear</h1>
          </figcaption>
...
CustomImageSpotlight4.propTypes = {
...
CustomImageSpotlight4.defaultProps = {
  mediaLink: "",
  mediaLinkBehavior: "",
  mediaScreenText: "",
...
export default CustomImageSpotlight4;
