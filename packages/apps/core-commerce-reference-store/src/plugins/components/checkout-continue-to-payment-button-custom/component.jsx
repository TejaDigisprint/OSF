 ...
 */
  ...
  * @param props
  */
 const CheckoutContinueToPaymentButtonCustom = props => {
   // resources
   const {
     actionConfirm,
     actionContinue,
 ...
 CheckoutContinueToPaymentButtonCustom.propTypes = {
   id: PropTypes.string.isRequired
 };
 
 export default CheckoutContinueToPaymentButtonCustom;
