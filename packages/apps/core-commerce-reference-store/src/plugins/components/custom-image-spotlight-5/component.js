 ...
 * @param props
 */
const CustomImageSpotlight5 = (props) => {
  // props
  const {
    mediaLink = "",
    mediaLinkBehavior = "",
    ...
    return (
      <>
        <div className={`Image_ImgContainer ${imgCSS}`}>
          <Link href="/clothing/category/Mclothing1">
            <img
              className="Img_Tag"
              
              src="/file/general/mensdress.jpg"
              title={mediaTitle}
              alt={mediaAlt}
          ...
          <figcaption style={textStyle} className="Image_FigCaption">
            <h1 className="Image_h1">Men Clothing</h1>
          </figcaption>
...
CustomImageSpotlight5.propTypes = {
...
CustomImageSpotlight5.defaultProps = {
  mediaLink: "",
  mediaLinkBehavior: "",
  mediaScreenText: "",
...
export default CustomImageSpotlight5;
